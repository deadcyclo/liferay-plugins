			...
			<c:if test="<%= messagesCount > 1 %>">
				...
				<aui:row>
					...
					if (messages != null) {
						...
						searchContainer = new SearchContainer(renderRequest, null, null, SearchContainer.DEFAULT_CUR_PARAM + thread.getThreadId(), SearchContainer.DEFAULT_DELTA, currentURLObj, null, null);
