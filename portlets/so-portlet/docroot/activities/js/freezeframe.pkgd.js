...
var freezeframe = (function($) { 
  ...
  var process = function ($_image) {
    ...
    context.drawImage($_image[0], 0, 0, image_width, image_height);
	  ...
	  var w = image_width/16;
	  var h = image_height/16;
	  var r = w < h ? w : h;

	  context.beginPath();
	  context.arc(w*8, h*8, r*2, 0, 2 * Math.PI, false);
	  ...
	  context.beginPath();
	  context.moveTo((w*8)-r+(r/10), (h*8)-r);
	  context.lineTo((w*8)+r+(r/10), (h*8));
	  context.lineTo((w*8)-r+(r/10), (h*8)+r);
	  context.moveTo((w*8)-r+(r/10), (h*8)-r);
